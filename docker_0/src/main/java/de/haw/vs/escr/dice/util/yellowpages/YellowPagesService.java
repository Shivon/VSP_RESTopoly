package de.haw.vs.escr.dice.util.yellowpages;
...
import de.haw.vs.escr.dice.util.inet.InetService;
import de.haw.vs.escr.dice.util.yellowpages.model.Service;
import de.haw.vs.escr.dice.util.yellowpages.model.ServiceList;
